...
const MyHeader = () => {
  ...
  return (
    <div className='pt-191 position-relative'>
      <img className='position-absolute top-0 ellipis1 end-0' src={ellipis1} alt="ellipis" />
      ...
      <div className="container">
        <h1 className='text-white ff-OpenSans fw-light text-center lh-xl m-0'>How to Benefit By Investing In <br /> AI Stocks For <span className='c-light-green'>High Returns</span></h1>
        <p className='text-center text-white opacity-75 ff-OpenSans fw-normal lh-lg-custom fs-md m-0 pt-17'>As per our research and data evaluation from experts, the <br /> price of these AI Stocks will rise over time. Today's <br /> Investment can give a return of more than 130.66% in 2024.</p>
