...
const MyHeader = () => {
  ...
  return (
    <div className='pt-191 position-relative'>
      <img className='position-absolute ellipis1 z-l  end-0' src={ellipis1} alt="ellipis" />
      <img className='position-absolute ellipis3 z-l start-0' src={ellipis2} alt="ellipis" />
      <img className='position-absolute ellipis2 z-l start-0' src={ellipis3} alt="ellipis" />
