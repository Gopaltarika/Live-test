...
const SevenAi = () => {
    const cards = [
        ...
        {
            id: 2,
            width: 'col-8 justify-content-end',
            max: 'max-w-697',
        ...
        <div className='mt-167 position-relative'>
            ...
            <div className="container">
                <div className="d-flex align-items-center justify-content-center gap-5">
                    ...
                    <h2 className='me-1 text-uppercase m-0 text-white fw-light fs-lg text-center ff-OpenSans'>TOP <span className='c-light-green'>sEVEN Ai</span> sOCK</h2>
